...
2. **A check** — a short, formative self-check on the facts or skills the unit
   builds on. This tells you whether you're ready, or whether to review first.
3. **Practice sets** — problems that build from straightforward to more
   involved.

Start at the top of a unit and work down. If a check reveals gaps, spend time
there before the practice sets — it pays off.
