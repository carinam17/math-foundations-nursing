...
!!! info "Scored vs Unscored Tablets"
    - **Scored tablets** have a line across the middle and 
      are designed to be split — 0.5 tablet is acceptable
...
\[\frac{500 \cancel{\text{ mg}}}{1} \times \frac{1 \text{ tablet}}{500 \cancel{\text{ mg}}} = 1 \text{ tablet per dose}\]
...
!!! example "Problem 5"
    Order: amoxicillin 500 mg orally
...
??? success "Answer"
    ...
    \[\frac{500 \cancel{\text{ mg}}}{1} \times \frac{1 \text{ capsule}}{250 \cancel{\text{ mg}}} = 2 \text{ capsules per dose}\]
...
??? success "Answer"
    ...
    !!! danger "Flag This"
        ...
        Before proceeding, verify the order, recheck the 
