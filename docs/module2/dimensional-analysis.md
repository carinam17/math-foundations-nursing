...
!!! info "Applying Dimensional Analysis to Dosing"
    Dimensional analysis is not just for conversions — it is 
    the foundation of all dosage calculations in later modules.

**Example:**
Order: 500 mg of amoxicillin
...
!!! example "Problem 4"
    A patient weighs 88 lb. A drug is ordered at 2 mg/kg.
