...
**Example 6:**
An IV is running at 125 mL/hr. 
How much fluid will the patient receive in 6 hours?

\[125 \text{ mL/hr} \times 6 \text{ hr} = 750 \text{ mL}\]

**Example 7:**
An IV is running at 75 mL/hr. 
...
**Example 8:**
A 1000 mL IV is running at 125 mL/hr.
...
??? success "Answer"
    ...
    !!! warning "Verify This Rate"
        ...
        the order and confirm with the prescriber 
        before programming the pump.
