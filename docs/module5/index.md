...
This module builds directly on the unit cancellation 
...
- Calculate drip rates in drops per minute (gtt/min) 
...
| Topic | Key Skills |
|---|---|
| [IV Flow Rates](iv-flow-rates.md) | mL/hr calculations, time conversion, pump programming |
| [Infusion Time](infusion-time.md) | Duration, completion time, rate adjustments |
| [Drip Rates](drip-rates.md) | gtt/min, drop factors, microdrip shortcut |
| [IV Medications](iv-medications.md) | Concentration, dose rates, weight-based infusions |
